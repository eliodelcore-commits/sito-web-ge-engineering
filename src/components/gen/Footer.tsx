...
const Footer = () => {
  return (
    <footer className="border-t border-border bg-background mt-auto">
      <div className="container mx-auto px-4 sm:px-6 py-6 md:py-0 md:h-20 flex items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
            <Link to="/" className="shrink-0">
              <img
                ...
                className="h-12 md:h-20 mix-blend-screen rounded-2xl opacity-90 hover:opacity-100 transition-opacity"
